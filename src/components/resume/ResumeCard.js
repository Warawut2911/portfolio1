...
const ResumeCard = ({title, subtitle, result, des}) => {
  return (
    <div className='w-full h-1/2 group flex'>
        ...
        <div className='w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg px-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne'>
            <div className='flex flex-col lgl:flex-row justify-between gap-4 lgl:gap- lgl:items-center'>
                <div>
